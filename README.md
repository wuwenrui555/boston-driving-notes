...
欣欣宝 ([@zhaozhangxin](https://github.com/zhaozhangxin)) 在波士顿学车的笔记.
...
**适用**: Pull over 起步, 平行停车, 三点掉头.

#### B. 行进口诀 (车一直在动, 方向盘 = 执行动作本身)
...
| 沿车道汇入 / 转弯 / 倒车 | 别人正常行驶可能撞你的空间 = 你的车体 (车头) 要侵入的空间  → **看车头摆向那一侧** |

- **前进时**: 车头摆向 = 方向盘方向
- **倒车时**: 车头摆向 = 方向盘**反方向** (后退时, 车尾摆向 = 方向盘方向)
...
- [驾驶习惯与提示 (Driving Habits & Tips)](./notes/driving-habits-and-tips.md): 双手姿势, 检查顺序, 脚刹换档, 观察习惯等
...
笔记内容采用 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) 许可.
