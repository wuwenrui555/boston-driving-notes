...
| 类型 | 风险来源 | 观察方向 |
| --- | --- | --- |
| 横穿马路（三点掉头、U-turn、出停车场穿过整条路） | 两边都来车（动态） | **左右都查** |
| 沿车道汇入（路边起步、变道、左转入对向车道、平行停车倒入） | 主要从车头摆向那一侧来（动态） | **车头摆向的那一侧** |

**关键**：看 **"车头摆向"**，不是看方向盘方向。

- **前进时**：车头摆向 = 方向盘方向（方向盘左 → 车头左 → 看左）
- **倒车时**：车头摆向 = 方向盘**反方向**（pivot 反向）
    - 例：平行停车倒入，方向盘**向右**打死，但车头**甩向左** → 看**左**
