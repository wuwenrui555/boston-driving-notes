...
路考开始前, 监考官会让你坐在驾驶座先做的三件事. 这部分很多人忽略, 如果答不出来或操作不对, **可能直接影响你能不能继续考试**.
...
| **任何坡度 + 没路牙子** | 向**右**打 (朝向路边) | 万一车辆滑动, 也尽量朝路边偏, 不要滑入主车道 |
...
- 路考开始时, 监考官会要求你示范手势信号
- 路考中会评估你在坡道上启停和转向的能力
- 上下坡停车时, 自动挡车辆要拉手刹并挂 `P` 档
- 靠路牙停车时, 前轮要朝正确方向打, 防止车辆在刹车失效时滑动
